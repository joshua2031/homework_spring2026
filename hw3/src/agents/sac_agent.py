    ...
    def update_critic(
        ...
        with torch.no_grad():
            ...
            if self.use_entropy_bonus and self.backup_entropy:
                ...
                # (B,)
                alpha = self.log_alpha.exp().detach() if self.auto_tune_temperature else self.temperature
                next_action_entropy = self.entropy(next_action_distribution)
                next_qs = next_qs + alpha * next_action_entropy[None]
                # ENDTODO
